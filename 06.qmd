...
::: {.img-float}
![1812 Cartoon of Ned Ludd](/images/06_images/ludd.png){style="float: left; margin: 5px; width: 250px;"}
:::
...
::: {.img-float}
![Roman Abacus](/images/06_images/roman_abacus.png){style="float: right; margin: 5px; width: 250px;"}
:::
...
::: {.img-float}
![Herman Hollerith's Tabulating Machine](/images/06_images/census_table.png){style="float: left; margin: 5px; width: 270px;"}
:::
...
#| fig-cap: "Change in Employment by Occupation, 1980-1990"
...
ax.set_title('Change in Employment by Occupation, 1980-1990', fontsize=14, fontweight='bold', pad=20)
...
![Employment growth across occupations by initial wage level](/images/06_images/autor_dorn_2013.png){#fig-job-polarization}
...
![Job polarization patterns across multiple countries](/images/06_images/acemoglu_autor_2011.png){#fig-polarization-countries}
...
| Task Type                | Example Occupations                      | Routine/Non-Routine | Cognitive/Manual | Predicted Change |
|--------------------------|------------------------------------------|---------------------|------------------|------------------|
| **Non-Routine Cognitive**| Managers, Engineers, Lawyers, Doctors   | Non-Routine         | Cognitive        | ↑ *Increase*     |
| **Routine Cognitive**    | Bookkeepers, Secretaries, Data Entry    | Routine             | Cognitive        | ↓ *Decrease*     |
| **Non-Routine Manual**   | Food Service, Janitors, Personal Care   | Non-Routine         | Manual           | ↑ *Increase*     |
| **Routine Manual**       | Assemblers, Machine Operators, Laborers | Routine             | Manual           | ↓ *Decrease*     |
:::
...
![Change in Employment Shares by Task Type, 1959-2007](/images/06_images/aa_11_2.png){#fig-task-changes}
...
## Tasks and Inequality 

Let's return to one measure of inequality that we have discussed -- the rising college wage premium. 
